...
def display_books(books):
    if not books:
        ...
        book_table = [[book.isbn, book.title, book.publisher,book.language, book.num_copies, book.availability] for book in books]
        print(tabulate(book_table, headers=["ISBN", "Title", "Publisher", "Language", "Number of Copies", "Availability"]))
